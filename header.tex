...
% Gamma
\newcommand{\GCB}{{\Gamma_{1 \text{c}}}}
\newcommand{\GVBx}{{\Gamma^{x}_{5 \text{v}}}}
\newcommand{\GVBy}{{\Gamma^{y}_{5 \text{v}}}}
\newcommand{\GVBz}{{\Gamma^{z}_{5 \text{v}}}}
\newcommand{\GVB}{{\Gamma_{5 \text{v}}}}
% L
\newcommand{\LCB}{{\text{L}_{1 \text{c}}}}
\newcommand{\LVBx}{{\text{L}^{x}_{3 \text{v}}}}
\newcommand{\LVBy}{{\text{L}^{y}_{3 \text{v}}}}
\newcommand{\LVB}{{\text{L}_{3 \text{v}}}}
% Mit Strich drüber
\newcommand{\bGCB}{{\bar \Gamma_{1 \text{c}}}}
\newcommand{\bGVBx}{{\bar \Gamma^{x}_{3 \text{v}}}}
\newcommand{\bGVBy}{{\bar \Gamma^{y}_{3 \text{v}}}}
\newcommand{\bGVB}[1]{{\bar \Gamma_{#1 \text{v}}}}
%% Impulsmatrixelemente
\newcommand{\PG}{{P_{\Gamma}}}
\newcommand{\PL}{{P_{\text{L}}}}
